        ...
        if es_monotributista:
            ...
            if meses_registrados > 0:
                ...
                if cuota_monotributo:
                    vencimiento_monotributo = self.calcular_vencimiento_monotributo()  # Calcula la fecha de vencimiento del pago de monotributo
                    self.repositorio.guardar_obligacion(
                        tipo_impuesto='Monotributo',  # Tipo de impuesto
                        monto_a_pagar=cuota_monotributo,  # Monto calculado a pagar
                        fecha_vencimiento=vencimiento_monotributo  # Fecha límite para el pago
                    )
