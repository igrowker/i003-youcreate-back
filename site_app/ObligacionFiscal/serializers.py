...
class ObligacionFiscalSerializer(serializers.ModelSerializer):
    class Meta:
        ...
        fields = [
            ...
            "estado_pago",
            "email_automatico",
        ]  # Campos que incluimos en la respuesta
        read_only_fields = [
            "tipo_impuesto",
            "monto_a_pagar",
            "fecha_vencimiento",
        ]  # Campos que solo se pueden leer, no se pueden modificar en la respuesta JSON
        update_fields = [
            "estado_pago",
            "email_automatico",
        ]  # Campos que se pueden actualizar en la respuesta JSON
