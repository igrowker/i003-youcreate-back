...
from .views import IngresosView, IngresosTotalesView, IngresosPorAnioView, IngresosPorMesView
...
urlpatterns = [
    ...
    path('ingresos-por-mes/<int:usuario_id>/<int:mes>', IngresosPorMesView.as_view(), name='ingresos-por-mes'),
